...
namespace PXTabs.Sample.Core
{
    ...
    {
        public TabsPage()         {             InitializeComponent();             SetTabs();         }          private void SetTabs()         {             List<PXTab> tabs = new List<PXTab>()             {                  CreateTab("Home", "ic_home_32dp", "ic_home_gray_32dp", Color.Red, Color.Gray, 0),
